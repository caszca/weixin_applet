...
__DEFINE__(1667029623189, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1667029623190,"./event-store":1667029623191}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667029623190, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1667029623191, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1667029623190,"./utils":1667029623192}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667029623192, function(require, module, exports) {
...
return __REQUIRE__(1667029623189);
})()
